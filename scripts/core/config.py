...
LIMITATIONS_PATH = "md/LIMITATIONS_TO_REVIEW.md"
...
FORBIDDEN_EDGES_MODULE_PATH = "scripts/constraints/04_forbidden_edges.py"
FORBIDDEN_EDGES_BACKUP_PATH = "scripts/constraints/04_forbidden_edges.py.bak"
FORBIDDEN_EDGES_REAL_MODULE_PATH = "scripts/constraints/04_forbidden_edges_real.py"
FORBIDDEN_EDGES_SYNTHETIC_MODULE_PATH = "scripts/constraints/04_forbidden_edges_synthetic.py"
