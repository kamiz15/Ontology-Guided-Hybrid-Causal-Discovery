...
ADAPTER_PATH = ROOT / "scripts" / "constraints" / "14_constraint_adapter.py"
FORBIDDEN_MODULE_CANDIDATES = [
    ROOT / "scripts" / "constraints" / "04_forbidden_edges_real.py",
    ROOT / "archive" / "04_forbidden_edges_real.py",
    ROOT / "scripts" / "constraints" / "04_forbidden_edges_real.py.bak",
]
